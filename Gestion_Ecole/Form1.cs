    ...
    public partial class Form1 : Form
    {
        ...
        private void ApplyStyles()
        {
            ...
            foreach (var btn in buttons)
            {
                ...
                btn.BackColor = Color.FromArgb(70, 130, 180); // Bleu acier
                btn.FlatStyle = FlatStyle.Flat;
                btn.FlatAppearance.BorderSize = 0;
                btn.Cursor = Cursors.Hand;
            }

            delete.BackColor = Color.FromArgb(220, 20, 60); // Rouge pour suppression
            b_Rechercher.BackColor = Color.FromArgb(34, 177, 76); // Vert pour recherche

            // Style du DataGridView
            DataEleve.BackgroundColor = Color.White;
            DataEleve.GridColor = Color.LightGray;
            DataEleve.DefaultCellStyle.BackColor = Color.White;
            DataEleve.DefaultCellStyle.ForeColor = Color.Black;
            DataEleve.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(70, 130, 180);
            DataEleve.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
